...
'''
牢记，Transformer架构在处理中文的时候是以字为单位
在处理英文的时候是以词为单位
...
class EncoderLayer(Layer):
    def __init__(self,heads=8,model_dim=512,units_dim=512,learning_rate=1e-5,drop_rate=0.2,**kwargs):
        self.heads = heads
        self.model_dim = model_dim
        ...
        self.layer_norm1 = LayerNormalization(epsilon=learning_rate)
        self.layer_norm2 = LayerNormalization(epsilon=learning_rate)
...
class DecoderLayer(Layer):
    def __init__(self,heads=8,model_dim=512,units_dim=512,learning_rate=1e-5,drop_rate=0.2,**kwargs):
        ...
        self.layer_norm1 = LayerNormalization(epsilon=learning_rate)
        self.layer_norm2 = LayerNormalization(epsilon=learning_rate)
        self.layer_norm3 = LayerNormalization(epsilon=learning_rate)
        self.dropout1 = Dropout(drop_rate)
        self.dropout2 = Dropout(drop_rate)
...
class Encoder(Layer):
    def __init__(self,num_layers,vocab_size,heads=8,model_dim=512,drop_rate=0.2,units_dim=512,learning_rate=1e-5,**kwargs):
        self.model_dim = model_dim
        self.heads = heads
        ...
        self.enc_layers = [EncoderLayer(model_dim=model_dim,heads=heads,units_dim=units_dim,drop_rate=drop_rate,learning_rate=learning_rate)
...
class Decoder(Layer):
    def __init__(self,num_layers,vocab_size,heads=8,model_dim=512,drop_rate=0.2,units_dim=512,learning_rate=1e-5,**kwargs):
        ...
        self.dec_layers = [DecoderLayer(model_dim=model_dim,heads=heads,units_dim=units_dim,drop_rate=drop_rate,learning_rate=learning_rate)
                       for _ in range(num_layers)]
...
class Transformer(Layer):
    def __init__(self,num_layers,vocab_size,heads=8,model_dim=512,drop_rate=0.2,units_dim=512,learning_rate=1e-5,**kwargs):
        self.encoder = Encoder(num_layers=num_layers,vocab_size=vocab_size,heads=heads,model_dim=model_dim,
                               drop_rate=drop_rate,units_dim=units_dim,learning_rate=learning_rate)
